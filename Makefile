...
SRC = draw.cpp game_start.cpp handle.cpp init_state.cpp gate.cpp main.cpp move_snake.cpp run.cpp
OBJ = draw.o game_start.o handle.o init_state.o gate.o main.o move_snake.o run.o
PROG = run
