...
SRC = draw.cpp game_start.cpp handle.cpp init_state.cpp main.cpp initPortals.cpp move_snake.cpp run.cpp
OBJ = draw.o game_start.o handle.o init_state.o main.o initPortals.o move_snake.o run.o
PROG = run
...
${OBJ} : ${SRC}
	...
	${CC} ${CFLAGS} -c -o initPortals.o initPortals.cpp
